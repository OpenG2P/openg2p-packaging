...
| Version | Date | Type |
| --- | --- | --- |
| [`0.0.0-develop.121`](#v-0-0-0-develop-121) | 2026-07-23 | develop |
| [`0.0.0-develop.116`](#v-0-0-0-develop-116) | 2026-07-20 | develop |
| [`0.0.0-develop.110`](#v-0-0-0-develop-110) | 2026-07-20 | develop |

# Develop builds

<a id="v-0-0-0-develop-121"></a>

## farmer-registry — develop 0.0.0-develop.121 (2026-07-23)

_commit `9cf5ec7` · baseline: release the start · previous build 0.0.0-develop.116_
<!-- build:0.0.0-develop.121 revision:9cf5ec777f072b489d064887ea99e555a3530d95 ts:1784774326 -->

### Summary

_All changes since release the start:_

- **Major:** Refactored deployment structure: inverted build model with registry-platform publishing base images and Helm chart, while farmer-registry extends it; renamed staff-portal-api to staff-api and dropped deployment/values.yaml.
...
- Testing improvements: added e2e sanity test suite with two power tests, fixed multiple issues causing test failures, and documented the sanity-testing process including DCI and change-request flows.
- CI/build updates: migrated to a central build-publish CI with pinned Dockerfiles, fixed repository mismatches, and cleaned up dead specifications; also updated Docker configurations for various services.
- Data model updates: enhanced SQL data models and templates for farmer extension, added support for geo reference data in db-seed, and updated seeding scripts for accuracy.
- Dependency management: pinned openg2p-registry dependency, updated various service image tags to latest versions, and corrected references in Chart.yaml.
- Documentation: added comprehensive documentation for Farmer Registry sanity-testing, including diagrams and procedures, and updated README for clarity.
- Miscellaneous fixes: resolved installation issues, corrected audit database wiring, and removed legacy logging and unused permissions.

### New in this build (since 0.0.0-develop.116)
...
<a id="v-0-0-0-develop-116"></a>

## farmer-registry — develop 0.0.0-develop.116 (2026-07-20)

_commit `4c66e68` · baseline: release the start · previous build 0.0.0-develop.110_
<!-- build:0.0.0-develop.116 revision:4c66e681fbd6fd8740f0064464d901733454ae6f ts:1784545303 -->

### Summary

_All changes since release the start:_

- **Major:** Enhanced security with default partner signature validation and consent enforcement; added CSRF validation for staff-portal-api requests.
- CI/build improvements: Migrated id-generator to GitLab, updated Docker configurations for various services, and consolidated helm chart with registry-platform libraries.
- E2E testing enhancements: Implemented a comprehensive sanity test suite, fixed install-time 403 errors, and ensured change-request tests pass end-to-end on live clusters.
- Data model updates: Refactored SQL data models for farmer extension, enhanced data seeding scripts, and updated incoming/outgoing templates structure.
...
- Documentation: Added a dedicated sanity-testing page and updated deployment README to reflect recent changes and testing procedures.
- Performance improvements: Implemented resource limits, fixed HPA bugs, and ensured Docker containers run as non-root for production hardening.
- Miscellaneous fixes: Resolved issues with stale audit comments, corrected permission mappings, and removed legacy logging.

### New in this build (since 0.0.0-develop.110)
...
## farmer-registry — develop 0.0.0-develop.110 (2026-07-20)

_commit `03eb3ca` · baseline: release the start · previous build 0.0.0-develop.109_
<!-- build:0.0.0-develop.110 revision:03eb3cad247750a8f7881beefb88105ebde0c9bd ts:1784525220 -->
...
- Security enhancements: enabled partner signature validation and consent enforcement by default, added CSRF validation for staff-portal-api requests, and updated IAM permissions for register metadata API access.
- CI/build improvements: transitioned to a central build-publish CI with self-contained pinned Dockerfiles, fixed pin/build-arg repo mismatches, and tidied up CI migration leftovers.
- E2E testing enhancements: added a comprehensive sanity test suite, fixed various install-time issues, and ensured change-request e2e tests pass on live clusters.
- Data seeding updates: enhanced scripts for loading geo reference data, updated SQL data models for farmer extension, and added new Jinja2 templates for DCI response.
- Refactoring efforts: updated SQL models and templates, renamed internal_record_id for clarity, and removed obsolete poverty score models.
- Documentation updates: added a Farmer Registry sanity-testing page and linked it from various deployment resources.

### New in this build (since 0.0.0-develop.109)
