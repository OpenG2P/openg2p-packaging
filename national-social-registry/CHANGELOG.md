...
| Version | Date | Type |
| --- | --- | --- |
| [`0.0.0-develop.157`](#v-0-0-0-develop-157) | 2026-07-23 | develop |
| [`0.0.0-develop.154`](#v-0-0-0-develop-154) | 2026-07-19 | develop |
| [`0.0.0-develop.152`](#v-0-0-0-develop-152) | 2026-07-19 | develop |

# Develop builds

<a id="v-0-0-0-develop-157"></a>

## national-social-registry — develop 0.0.0-develop.157 (2026-07-23)

_commit `614b938` · baseline: release the start · previous build 0.0.0-develop.154_
<!-- build:0.0.0-develop.157 revision:614b9383f3c7086b4d61e77d20f5ec32eaa1d90e ts:1784783935 -->

### Summary

_All changes since release the start:_

- **Major:** NSR refactor: replaced self-sufficient chart with openg2p-nsr wrapper, streamlined Docker images, and removed legacy db-seed/celery machinery.
- Security enhancements: added CSRF validation for staff-portal-api requests and implemented IAM public URL configuration for Staff Portal UI.
- CI/CD improvements: cleaned up CI migration artifacts, updated Helm chart configurations, and enhanced Dockerfile for better data loading.
- Feature additions: introduced contributing attributes for poverty scoring, pre-approval logic for change requests, and new JSON templates for DCI response handling.
- Dependency management: pinned openg2p-registry to a specific version, updated various library versions, and frozen AWE version.
- Resource management: enforced non-root user execution for Docker containers, fixed resource limits, and addressed OOM issues in Redis.
- Data integrity: updated SQL seed data for households and individuals, removed duplicate entries, and improved geo hierarchy handling in data loading scripts.
- Refactoring efforts: improved validation functions, renamed methods for clarity, and enhanced JSON handling in data insertion processes.
- Documentation updates: added README for NSR extension package and moved documentation to Gitbook.

### New in this build (since 0.0.0-develop.154)
