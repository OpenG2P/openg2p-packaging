## partner-management — Unreleased (0.0.0-develop.10, 2026-07-13)

_commit `5d68968` · baseline: release the start_
<!-- build:0.0.0-develop.10 revision:5d68968984ff2f37e119e2fce7390719f7c68af4 -->

### Summary

_All changes since release the start:_

- Improved automated testing and workflow stability.
- Added auditing capabilities for better tracking.
- Minor user interface adjustments.
- Corrected the default audit manager URL.
