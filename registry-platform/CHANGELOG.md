...
| [`0.0.0-develop.284`](#v-0-0-0-develop-284) | 2026-07-22 | develop |
| [`0.0.0-develop.283`](#v-0-0-0-develop-283) | 2026-07-22 | develop |
...
## registry-platform — develop 0.0.0-develop.284 (2026-07-22)

_commit `aebd339` · baseline: release v1.0.0 · previous build 0.0.0-develop.283_
<!-- build:0.0.0-develop.284 revision:aebd3399642c4b65bd90c9e354c3d374bc60974b ts:1784718778 -->

### Summary

_All changes since release v1.0.0:_

- **Major:** CI/CD overhaul with a unified build-publish workflow for all images and charts, consolidating the staff-ui and streamlining Docker configurations.
- Database and schema updates: cleaned up reference registry, corrected seed handling for individual and household groups, and ensured DCI search resolves correctly with new core schema integrations.
- Sanity testing enhancements: improved e2e logging with timestamped results, fixed scope mismatches, and ensured full green status for reference e2e tests.
- Refactor and cleanup: streamlined document handling across various services, removed deprecated classes, and enhanced error handling and logging for better maintainability.
- Security improvements: added CSRF validation for API requests, implemented client-side CSRF token handling, and updated IAM permission management.
- Feature additions: introduced configurable reference generators, enhanced file validation profiles, and added new data policy management features.
- Dependency updates: synchronized ui-widgets versions and updated various library dependencies to maintain compatibility and performance.

### New in this build (since 0.0.0-develop.283)
...
<a id="v-0-0-0-develop-283"></a>

## registry-platform — develop 0.0.0-develop.283 (2026-07-22)

_commit `d7139ea` · baseline: release v1.0.0_
<!-- build:0.0.0-develop.283 revision:d7139ea1bb36a12681daa5805cfb16a80d747d50 ts:1784716194 -->

### Summary

_All changes since release v1.0.0:_

- **Major:** Reference registry cleanup: removed broken inbound message-rule seed, corrected Dockerfile/README comments, and ensured the reference registry is runnable with the Option-C model.
- Testing enhancements: improved e2e test logging with timestamped step lines and reduced noise from httpx and pytest; ensured reference e2e tests are fully green.
- Database improvements: implemented collision-tolerant seeding for individual and household groups, updated DCI seed to core schema, and ensured minimal seed with demo-data loaders is functional.
- Refactoring and cleanup: streamlined document handling across various components, updated attribute fetching in the UI, and removed deprecated classes and unused code.
- Security updates: added CSRF validation for staff-portal-api requests and client-side CSRF token handling.
- Feature additions: introduced new data policy management features, enhanced file validation and upload profiles, and added application reference field generation.
- Dependency updates: synchronized ui-widgets versioning and updated @openg2p/registry-widgets to 1.1.4.
- UI improvements: enhanced geo hierarchy layout, improved column distribution logic, and added new icons for better user experience.
