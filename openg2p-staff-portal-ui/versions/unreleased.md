## openg2p-staff-portal-ui — Unreleased (0.0.0-develop.54, 2026-07-13)

_commit `beb29e2` · baseline: release v1.1.0_
<!-- build:0.0.0-develop.54 revision:beb29e20dfe49d9da1642d63f1608f12746412dd -->

### Summary

_All changes since release v1.1.0:_

- Improved security with new CSRF token handling.
- Enhanced authentication and logout processes.
- Updated environment variable management.

### Since last release (v1.1.0)
