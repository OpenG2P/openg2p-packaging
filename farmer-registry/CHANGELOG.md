...
## farmer-registry — develop 0.0.0-develop.107 (2026-07-19)

_commit `a355584` · baseline: release the start · previous build 0.0.0-develop.105_
<!-- build:0.0.0-develop.107 revision:a355584bf66db8bf8cd63d01a0eaf5515621394f ts:1784482381 -->

### Summary

_All changes since release the start:_

- **Major:** Migration of id-generator to GitLab with updated Chart.yaml reference; IAM service repo renamed and now uses openg2p/iam-service.
- E2E testing improvements: fixed sanity DCI tests for functional_record_id, adjusted install-time hooks to prevent 403 errors, and enhanced retry logic for startup races; added a comprehensive sanity test suite.
...
- CI/CD updates: transitioned to a central build-publish CI with self-contained pinned Dockerfiles, removed legacy logging, and tidied up CI migration leftovers.
- Dependency management: updated various dependencies and image tags to latest versions, including freezing AWE and postgres-init versions.
- Data seeding enhancements: added support for geo reference data loading, updated SQL data models for farmer extension, and improved seeding scripts for accuracy and completeness.
- Documentation updates: added a dedicated sanity-testing page and linked it from deployment README and helm-chart, along with various other documentation improvements.
- Refactoring efforts: updated naming conventions for IDs and models, removed obsolete fields, and streamlined data models for clarity and consistency.

### New in this build (since 0.0.0-develop.105)
...
## farmer-registry — develop 0.0.0-develop.105 (2026-07-19)

_commit `fd9bbda` · baseline: release the start · previous build 0.0.0-develop.104_
<!-- build:0.0.0-develop.105 revision:fd9bbdabcd1a08eb1a0b1208f32e2cd7edead188 ts:1784461185 -->

### Summary

_All changes since release the start:_

- [G2P-5260](https://openg2p.atlassian.net/browse/G2P-5260) AWE removed from the project; Commons AWE is now used instead.
- [G2P-5378](https://openg2p.atlassian.net/browse/G2P-5378) Fail closed by default: partner signature validation and consent enforcement are now enabled by default, aligning with registry platform standards.
- [G2P-5378](https://openg2p.atlassian.net/browse/G2P-5378) Sanity e2e test suite added with two power e2e tests to enhance testing coverage.
- [G2P-5378](https://openg2p.atlassian.net/browse/G2P-5378) Fix sanity DCI e2e tests to ensure chart searchText uses the farmer's functional_record_id instead of the SANITYE2E marker.
- [G2P-5378](https://openg2p.atlassian.net/browse/G2P-5378) Fix sanity e2e install-time 403 errors by adjusting the execution order of the sanity test Job and IAM role permissions.
- [G2P-5378](https://openg2p.atlassian.net/browse/G2P-5378) Enhance change-request e2e tests to pass end-to-end on a live cluster by granting necessary permissions and fixing polling mechanisms.
- [G2P-5319](https://openg2p.atlassian.net/browse/G2P-5319) Production hardening: resource limits fixed, HPA bug resolved, and Docker containers now run as non-root.
- [G2P-5221](https://openg2p.atlassian.net/browse/G2P-5221) Add IAM public URL configuration for Staff Portal UI to improve accessibility.
- [G2P-5255](https://openg2p.atlassian.net/browse/G2P-5255) Add CSRF validation configuration for staff-portal-api requests to enhance security.
- [G2P-5378](https://openg2p.atlassian.net/browse/G2P-5378) Documentation updated to include a Farmer Registry sanity-testing page with comprehensive testing procedures and diagrams.
- [G2P-5335](https://openg2p.atlassian.net/browse/G2P-5335) Move to central build-publish CI with self-contained pinned Dockerfiles for better consistency.
- [G2P-5335](https://openg2p.atlassian.net/browse/G2P-5335) Fix pin/build-arg repo mismatch by installing iam-core from the correct repository.
- [G2P-5378](https://openg2p.atlassian.net/browse/G2P-5378) Make change-request e2e tests more resilient to install-time startup races by implementing retry logic.
- [G2P-5378](https://openg2p.atlassian.net/browse/G2P-5378) Fix sanity audit-DB wiring to ensure correct Secret usage for audit tests.
- [G2P-5222](https://openg2p.atlassian.net/browse/G2P-5222) Sanity tests added to improve testing reliability and coverage.
- [G2P-5202](https://openg2p.atlassian.net/browse/G2P-5202) Bump dependencies and update image tags to the latest versions for improved performance and security.
- [G2P-5186](https://openg2p.atlassian.net/browse/G2P-5186) Duplicate jobs with the same name removed to streamline job management.
- [G2P-5143](https://openg2p.atlassian.net/browse/G2P-5143) IAM traces removed upon uninstallation to ensure a clean environment.
- [G2P-5142](https://openg2p.atlassian.net/browse/G2P-5142) Update language data seeding by adding new fields and removing obsolete ones.
- [G2P-4695](https://openg2p.atlassian.net/browse/G2P-4695) Refactor to remove poverty score models from the initialization process for cleaner code.
- [G2P-4694](https://openg2p.atlassian.net/browse/G2P-4694) Add async method to link internal record ID for improved data handling.
- [G2P-4692](https://openg2p.atlassian.net/browse/G2P-4692) Various enhancements made to data models and templates for farmer extension.
- [G2P-4904](https://openg2p.atlassian.net/browse/G2P-4904) Seed AWE approval policies for Farmer Registry to ensure compliance with new standards.
- [G2P-5187](https://openg2p.atlassian.net/browse/G2P-5187) Update versioning to follow the '0.0.0-develop.N' convention for better clarity.
- [G2P-5221](https://openg2p.atlassian.net/browse/G2P-5221) Update AWE approver user passwords and add first/last names for new users in keycloak-init.
- [G2P-5226](https://openg2p.atlassian.net/browse/G2P-5226) Add Redis configuration for staff-portal-api authentication to improve performance.
- [G2P-5221](https://openg2p.atlassian.net/browse/G2P-5221) Remove unused verification permissions from payload.json to clean up the codebase.
- [G2P-5207](https://openg2p.atlassian.net/browse/G2P-5207) Fix translations and UI schema seeding to ensure accurate data representation.
- [G2P-5318](https://openg2p.atlassian.net/browse/G2P-5318) Sync operational role IAM permissions for register metadata API access to enhance security.
- [G2P-5125](https://openg2p.atlassian.net/browse/G2P-5125) Consolid

### New in this build (since 0.0.0-develop.104)
