...
| Version | Date | Type |
| --- | --- | --- |
| [`0.0.0-develop.154`](#v-0-0-0-develop-154) | 2026-07-19 | develop |
| [`0.0.0-develop.152`](#v-0-0-0-develop-152) | 2026-07-19 | develop |
| [`0.0.0-develop.150`](#v-0-0-0-develop-150) | 2026-07-19 | develop |

# Develop builds

<a id="v-0-0-0-develop-154"></a>

## national-social-registry — develop 0.0.0-develop.154 (2026-07-19)

_commit `3e44be7` · baseline: release the start · previous build 0.0.0-develop.152_
<!-- build:0.0.0-develop.154 revision:3e44be794f1759d453862f632845e5fd378c5c0a ts:1784482748 -->

### Summary

_All changes since release the start:_

- **Major:** Production hardening with resource limits and HPA bug fixes; Docker containers now run as non-root users.
- Security enhancements: CSRF validation added for staff-portal-api requests, and IAM permissions synced for register metadata API access.
- CI/CD improvements: Tidy-up of CI migration artifacts, updates to Helm chart configurations, and Dockerfile adjustments for better data loading and image handling.
- Refactoring efforts: Improved validation functions across services, renamed methods for clarity, and cleaned up legacy logging and hardcoded values.
- Database updates: Enhanced geo data loading, updated SQL seed data for consistency, and removed duplicate entries.
- Dependency management: Bumped versions of various libraries and components, including AWE and PostgreSQL initialization.
- New features: Implemented pre-approval logic for change requests, added support for multiple registries in an environment, and introduced G2PCrvsVCIndividualCreateEnricherService for individual mapping.
- Documentation updates: README added for NSR extension package, and migration of documentation to Gitbook.

### New in this build (since 0.0.0-develop.152)
...
<a id="v-0-0-0-develop-152"></a>

## national-social-registry — develop 0.0.0-develop.152 (2026-07-19)

_commit `035a8a1` · baseline: release the start · previous build 0.0.0-develop.150_
<!-- build:0.0.0-develop.152 revision:035a8a1e75e737ede44492fa3dc7a744eb9b0fe9 ts:1784482688 -->

### Summary

_All changes since release the start:_

- **Major:** Production hardening with resource limits, HPA bug fixes, and Docker containers running as non-root users.
- Security enhancements: Added CSRF validation for staff-portal-api requests and synchronized IAM permissions for register metadata API access.
- CI/CD improvements: Refactored CI migration remnants, updated Helm chart configurations, and implemented a new versioning system for deployments.
- Feature additions: Introduced pre-approval logic for change requests, enhanced db-seed functionality, and added support for multiple registries in an environment.
- Dependency updates: Bumped various dependencies and updated Docker images to the latest versions, including freezing AWE and postgres-init versions.
- Refactoring efforts: Cleaned up search text keys, improved validation functions, and renamed several methods for clarity and consistency.
- Documentation updates: Added a README for the NSR extension package and moved documentation to Gitbook.
- Bug fixes: Resolved issues related to recent changes, fixed SQL bugs, and addressed OOM errors in Redis by removing memory limits.

### New in this build (since 0.0.0-develop.150)
...
## national-social-registry — develop 0.0.0-develop.150 (2026-07-19)

_commit `a946c73` · baseline: release the start_
<!-- build:0.0.0-develop.150 revision:a946c73a4ef76fdf9bbafbd11cef0cd69fb93ca6 ts:1784461284 -->

### Summary

_All changes since release the start:_

- [G2P-5260](https://openg2p.atlassian.net/browse/G2P-5260) AWE removed from here; Commons AWE is now used.
- [G2P-5319](https://openg2p.atlassian.net/browse/G2P-5319) Dockers now run as a non-root user for enhanced security.
- [G2P-5319](https://openg2p.atlassian.net/browse/G2P-5319) Production hardening implemented, fixing resource limits and HPA bugs.
- [G2P-5143](https://openg2p.atlassian.net/browse/G2P-5143) IAM traces uninstalled with an uninstall script.
- [G2P-5010](https://openg2p.atlassian.net/browse/G2P-5010) Registry staff portal UI Docker moved to the registry platform as it is a common component.
- [G2P-5010](https://openg2p.atlassian.net/browse/G2P-5010) Helm chart made self-sufficient; all contents copied from openg2p-registry-gen2-deployment.
- [G2P-5010](https://openg2p.atlassian.net/browse/G2P-5010) Memory limits removed due to OOM issues.
- [G2P-5187](https://openg2p.atlassian.net/browse/G2P-5187) New versioning system introduced; version bumped up with each change.
- [G2P-5202](https://openg2p.atlassian.net/browse/G2P-5202) Dependencies bumped and image tags updated to the latest versions.
- [G2P-5318](https://openg2p.atlassian.net/browse/G2P-5318) Operational role IAM permissions synced for register metadata API access.
- [G2P-5255](https://openg2p.atlassian.net/browse/G2P-5255) CSRF validation configuration added for staff-portal-api requests.
- [G2P-5221](https://openg2p.atlassian.net/browse/G2P-5221) IAM public URL configuration added for Staff Portal UI.
- [G2P-5226](https://openg2p.atlassian.net/browse/G2P-5226) Redis configuration added for staff-portal-api authentication.
- [G2P-5221](https://openg2p.atlassian.net/browse/G2P-5221) Updated AWE approver user password and added first/last names for new users in keycloak-init.
- [G2P-5221](https://openg2p.atlassian.net/browse/G2P-5221) CSP configuration added for profile/document images from MinIO.
- [G2P-5221](https://openg2p.atlassian.net/browse/G2P-5221) Removed unused verification permissions from payload.json.
- [G2P-5319](https://openg2p.atlassian.net/browse/G2P-5319) Reference updated to the develop branch of registry-platform.
- [G2P-5348](https://openg2p.atlassian.net/browse/G2P-5348) id-generator moved to Gitlab; reference in Chart.yaml updated.
- [G2P-5335](https://openg2p.atlassian.net/browse/G2P-5335) CI-migration leftovers tidied up in farmer; dead develop.txt specs dropped.
- [G2P-4807](https://openg2p.atlassian.net/browse/G2P-4807) Added DCI response templates and enrichers for individual mapping.
- [G2P-4807](https://openg2p.atlassian.net/browse/G2P-4807) Enhanced G2PRegisterDomainServiceIndividual with post-ingest and post-approve methods.
- [G2P-4807](https://openg2p.atlassian.net/browse/G2P-4807) Added dci-workshop configuration files for partner and staff portal APIs.
- [G2P-4807](https://openg2p.atlassian.net/browse/G2P-4807) Updated iam-service version to v1.1.0.
- [G2P-4807](https://openg2p.atlassian.net/browse/G2P-4807) Enhanced db-seed Docker image to support Jinja template uploads.
- [G2P-4807](https://openg2p.atlassian.net/browse/G2P-4807) Added G2PCrvsVCIndividualCreateEnricherService and updated templates.
- [G2P-4807](https://openg2p.atlassian.net/browse/G2P-4807) Improved error handling in G2PCrvsVCIndividualCreateEnricherService.
- [G2P-4807](https://openg2p.atlassian.net/browse/G2P-4807) Added husband status fields to household model and schema.
- [G2P-4807](https://openg2p.atlassian.net/browse/G2P-4807) Enhanced NSR extension with new register metadata, UI tabs, and scoring definitions.
- [G2P-4807](https://openg2p.atlassian.net/browse/G2P-4807) Added JSON templates for DCI commons response and individual to DCI mapping.
- [G2P-4807](https://openg2p.atlassian.net/browse/G2P-4807) Enhanced JSON template for CRVS individual data processing.
- [G2P-4807](https://openg2p.atlassian.net/browse/G2P-4807) Normalized CRVS envelope and enhanced G2PCrvsVCIndividualCreateEnricherService.
- [G2P-4807](https://openg2p.atlassian.net/browse/G2P-4807) Updated SQL seed data and templates for DCI and CRVSVC integration.
- [G2P-4807](https://openg2p.atlassian.net/browse/G2P-4807) Updated SQL seed data for households with corrected household head names and improved data consistency.
- [G2P-4807](https://openg2p.atlassian.net/browse/G2P-4807) Updated SQL seed data for configurations and sample data.
- G2P-
